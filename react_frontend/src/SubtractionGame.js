...
/**
 * SubtractionGame Component
 *
 * Presents random subtraction problems, accepts user answer (numeric/pad/keyboard), gives immediate feedback,
 * tracks score, and allows reset/replay. Style matches AdditionGame/Calculator for consistency.
 *
 * Props: none
 */
...
function SubtractionGame() {
  ...
  // Generate a new subtraction problem (ensure num1 >= num2, both 2-digit)
  // PUBLIC_INTERFACE
  function newProblem() {
  ...
  function handleInput(e) {
    // Only allow numbers, optional negative for cases like 12-14=-2
  ...
  const handleMinus = () => {
    // Only allow minus if at the beginning and answer is empty
  ...
  return (
    ...
    >
      ...
      <div
        ...
        aria-label="Current subtraction problem"
      >
        {num1 !== null && num2 !== null ? (
          <>{num1}&nbsp;-&nbsp;{num2} = ?</>
        ) : (
