...
/**
 * AdditionGame Component
 *
 * Presents random addition problems, accepts user answer (with keypad/keyboard support), gives immediate feedback,
...
function AdditionGame() {
  ...
  // PUBLIC_INTERFACE
  function newProblem() {
    const a = Math.floor(Math.random() * 90) + 10; // 2-digit for interest
  ...
  return (
    ...
    >
      ...
      <div
        ...
        aria-label="Current addition problem"
      >
        {num1 !== null && num2 !== null ? (
          <>{num1}&nbsp;+&nbsp;{num2} = ?</>
        ) : (
